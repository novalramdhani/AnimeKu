<x-app-layout title="Ani Cast - Anime Shows">
    <div class="container px-4 pt-16">
        <div class="upcoming-anime">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-8">
                @foreach ($upComing as $anime)
                    <div class="mt-8">
                        <a href=""><img src="{{ $anime['images']['jpg']['image_url'] }}" class="hover:opacity-75 transition case-in-out duration-150 h-80 w-80" alt="Poster"></a>
                        <div class="mt-2">
                            <a href="" class="text-lg mt-2 text-white hover:text-gray-300">{{ $anime['title'] }}</a>
        ...
        <div class="recommendations-anime py-24">
            <h2 class="uppercase tracking-wider text-purple-600 text-lg font-semibold">Recommendations Anime</h2>
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-8">
